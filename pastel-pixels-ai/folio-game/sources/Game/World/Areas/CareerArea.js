...
export class CareerArea extends Area {
    ...
    setLines() {
        ...
        for (const group of lineGroups) {
            ...
            // Custom text mapping for InterLayer customization
            const textMappings = {
                'careerFreelancer': 'Startups',
                'careerHetic': 'Education',
                'careerImmersiveGarden': 'InterLayer',
                'careerIRLTeacher': 'Leadership',
                'careerOnlineTeacher': 'Innovation',
                'careerUzik': 'Advisory'
            }

            if (textMappings[line.group.userData.texture]) {
                ...
                textCanvas.updateText(textMappings[line.group.userData.texture])
                line.texture = textCanvas.texture
            }
            else {
